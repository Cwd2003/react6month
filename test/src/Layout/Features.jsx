                ...
                <div className="feature-carousel owl-carousel">
                    <div className="feature-item wow fadeInUp" data-wow-delay="0.2s">
                        <div className="feature-img">
                            <img src="/assets/img/feature-1.jpg" className="img-fluid w-100"  alt=""/>
                        </div>
                    ...
                    <div className="feature-item wow fadeInUp" data-wow-delay="0.4s">
                        <div className="feature-img">
                            <img src="/assets/img/feature-2.jpg" className="img-fluid w-100"  alt=""/>
                        </div>
                        <div className="feature-content p-4">
                    ...
                    <div className="feature-item wow fadeInUp" data-wow-delay="0.6s">
                        <div className="feature-img">
                            <img src="/assets/img/feature-3.jpg" className="img-fluid w-100"  alt=""/>
                        </div>
                        <div className="feature-content p-4">
                    ...
                    <div className="feature-item">
                        <div className="feature-img">
                            <img src="/assets/img/feature-4.jpg" className="img-fluid w-100"  alt=""/>
                        </div>
                        <div className="feature-content p-4">
